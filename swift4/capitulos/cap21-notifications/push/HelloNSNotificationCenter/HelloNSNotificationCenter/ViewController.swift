...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ViewController.recebeNotificacao), name: NSNotification.Name(rawValue: "MINHA_NOTIFICACAO"), object: nil)
    }
